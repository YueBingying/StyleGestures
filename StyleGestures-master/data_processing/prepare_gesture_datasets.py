...
if __name__ == "__main__":
    ...
    # bvhpath = os.path.join(data_root, 'Motion') #bvh
    # audiopath = os.path.join(data_root, 'Audio') #audio
    # held_out = ['Recording_008']
    # processed_dir = '../data/GENEA/processed'
    data_root = '..\data\GENEA\source\Training_data'
    bvhpath = os.path.join(data_root, 'Motion') #bvh
    audiopath = os.path.join(data_root, 'Audio') #audio
    held_out = ['Recording_008']
    processed_dir = '..\data\GENEA\processed_train'
